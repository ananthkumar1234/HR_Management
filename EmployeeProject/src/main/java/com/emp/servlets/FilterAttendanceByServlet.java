...
@WebServlet("/filterAttendanceBy")
public class FilterAttendanceByServlet extends HttpServlet {
...
//        if ("attendance".equals(origin)) {
            request.getRequestDispatcher("employeesAttendance.jsp").forward(request, response);
//        } else {
